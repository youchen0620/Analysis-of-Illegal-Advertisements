...
vectordb = Chroma(persist_directory="db/original_history", embedding_function=embedding)
...
for i, question in tqdm(enumerate(questions)):
    ...
    print(result)
    with open('output/2.5-flash-rag-original-history-top3-similarity-without-laws.jsonl', 'a', encoding='utf-8') as f:
